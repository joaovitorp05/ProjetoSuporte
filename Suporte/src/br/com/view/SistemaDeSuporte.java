...
public class SistemaDeSuporte extends JFrame {
	...
	private JTextField txtdepSolicitado;
	...
	public SistemaDeSuporte() {
		...
		txtdepSolicitado = new JTextField();
		txtdepSolicitado.setBounds(35, 137, 188, 20);
		contentPane.add(txtdepSolicitado);
		txtdepSolicitado.setColumns(10);
		...
		btnRegistrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				txtdepSolicitado.getText().trim().equals("") || 
				...
				soliChamado.setDepSolicitado(txtdepSolicitado.getText()); 
