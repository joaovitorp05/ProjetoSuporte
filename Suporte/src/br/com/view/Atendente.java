...
public class Atendente extends JFrame {
	...
	public Atendente() {
		...
		lblNewLabel.setBounds(42, 23, 75, 28);
		...
		lblNewLabel_1.setBounds(384, 30, 86, 14);
		...
		lblNewLabel_2.setBounds(10, 127, 190, 14);
		...
		lblNewLabel_3.setBounds(361, 127, 140, 14);
		...
		lblNewLabel_4.setBounds(121, 227, 94, 14);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(txtResponsavel.getText().trim().equals("") || txtStatus.getText().trim().equals("") ||
					...
					JOptionPane.showMessageDialog(null, "Os campos Responsável Chamado, Id do Chamado,"
							+ "Status do Chamado e Data de Resolução devem ser preenchidos", "Erro 4000765x" , JOptionPane.ERROR_MESSAGE); 
				}
				else {
		...
		btnAtualizar.setBounds(381, 252, 145, 42);
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(txtId.equals(null)) {
					...
					if(JOptionPane.showConfirmDialog(null, "Voce tem certeza desta ação? Está ação é"
		...
		btnExcluir.setBounds(381, 321, 145, 42);
